...
public class VisualizarEstoqueSwing extends JFrame {
    ...
    public VisualizarEstoqueSwing() {
        super("EasyFarma - Visualizar Estoque");
    ...
    private void initComponents() {
        ...
        JButton btnCadastrarReceita = criarBotaoMenu("Cadastrar Receita", () -> {
            // Substitua pela tela Swing de cadastro de receita
            // new CadastrarReceitaSwing(receitaController).setVisible(true);
            dispose();
        });
        JButton btnPesquisarReceita = criarBotaoMenu("Pesquisar Receita", () -> {
            // Substitua pela tela Swing de pesquisa de receita
        ...
        JButton btnSair = criarBotaoMenu("Sair", () -> dispose());
        ...
        // Painel de pesquisa para medicamentos
    ...
    // Pesquisa medicamentos pelo nome
    ...
    /**
     * Método auxiliar para criar um botão para o menu lateral com a ação especificada.
     */
