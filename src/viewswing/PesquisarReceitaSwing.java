...
public class PesquisarReceitaSwing extends JFrame {
    ...
    public PesquisarReceitaSwing() {
        super("EasyFarma - Pesquisar Receita");
    ...
    private void initComponents() {
        ...
        btnSair = criarBotaoMenu("Sair", this::dispose);
        ...
        btnExportar.addActionListener(e -> {
            ...
            int result = fileChooser.showSaveDialog(PesquisarReceitaSwing.this);
